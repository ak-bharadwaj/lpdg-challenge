...
def test_zero_wall_clock_in_production_code():
    ...
    # Operational CLI scripts (check_drift.py, rollback.py, promote.py, ops.py) capture live runtime execution timestamps for audit reports
    exempt_monitoring_scripts = {"check_drift.py", "rollback.py", "promote.py", "ops.py"}
    all_violations = []
